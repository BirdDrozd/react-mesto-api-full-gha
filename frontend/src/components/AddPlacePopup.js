...
function AddPlacePopup({ isOpen, onClose, onAddPlace, isLoading }) {
  ...
  return (
    ...
    >
      <input 
        type="text" 
        className={`popup__input popup__input_content_name ${!errors.name ? "" : "popup__input_type_error"}`} 
        name="name" 
      ...
      <input 
        type="url" 
        className={`popup__input popup__input_content_link ${!errors.link ? "" : "popup__input_type_error" }`} 
        name="link" 
